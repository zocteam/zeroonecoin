...
static const unsigned int MAX_ADDR_TO_SEND = 500; //1000
...
static const int MAX_OUTBOUND_CONNECTIONS = 8; //16
/** Maximum number of addnode outgoing nodes */
static const int MAX_ADDNODE_CONNECTIONS = 4; //8
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 32; //125
...
static const size_t DEFAULT_MAXRECEIVEBUFFER = 5 * 500; //5*1000
static const size_t DEFAULT_MAXSENDBUFFER    = 1 * 500; //1*1000
